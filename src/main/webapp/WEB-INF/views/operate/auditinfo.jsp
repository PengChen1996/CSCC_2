	    ...
	    <div class="row">
	        <div class="col-md-3">
	            <div id="operate_list" class="list-group" style="width:200px;">
	                ...
	                <a class="list-group-item" style="border-radius: 0;"><span class="glyphicon glyphicon-search"></span>&nbsp;&nbsp;操作日志</a>
	            </div>
	        </div>
	        <br>
	        <div class="col-md-9" style="margin-left: -25px;min-height: 420px;">
